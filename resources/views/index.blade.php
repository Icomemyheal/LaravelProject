...
<html lang="en">
    <head>
        ...
        <title>Techno Shop: Інтернет магазин</title>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="/images/i5intelcore.jpg" alt="i5intelcore" width="450px" height="300px"/>
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Intel Core I5-12600K</h5>
                                    <!-- Product price-->
                                    4 439₴
                                </div>
                            </div>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/product/i5-12600K">Детальніше</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
